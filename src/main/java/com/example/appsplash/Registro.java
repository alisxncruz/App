...
import com.example.appsplash.BaseDatos.BDUsuarios;
import com.example.appsplash.Des.MyDesUtil;
import com.example.appsplash.Method.Sha;

import java.util.ArrayList;
import java.util.List;

public class Registro extends AppCompatActivity{
    private EditText nombre, usuario, correo, edad, password;
